...
To provide filtering, No AI Feed may process the following information inside the user's browser:
...
No AI Feed does not sell user data. The developer does not receive user data from the extension and therefore does not share it for advertising, profiling, or unrelated purposes.
...
If a future version changes how user data is handled, this policy and any applicable store disclosures will be updated before or alongside that release.

## Contact

For privacy questions or issues, open an issue in this GitHub repository.